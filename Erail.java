...
public class Erail {
	...
	public static void main(String[] args) {
		...
		List<WebElement> noofTrians = driver.findElements(By.xpath("//table[@class ='DataTable TrainList TrainListHeader']//tr"));
		System.out.println("Train count :" + noofTrians.size());
		...
		for (int i = 0; i < noofTrians.size(); i++) {
			WebElement elet = noofTrians.get(i);
